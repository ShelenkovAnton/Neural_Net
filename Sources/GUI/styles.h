...
public:
    ...
    static auto aply_checkable_btn_style( QWidget* const ) -> void;

    static const struct Colors
    {
        static constexpr auto window_background      = "#27292D";
        static constexpr auto btn_background         = "#1F2023";
        static constexpr auto checked_btn_background = "#414144";
        static constexpr auto hovered_btn_background = "#0000FF";
    } colors;
};
